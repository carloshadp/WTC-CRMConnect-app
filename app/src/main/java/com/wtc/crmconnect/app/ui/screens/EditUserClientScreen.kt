...
fun EditUserClientScreen(
    ...
    Scaffold(
        ...
        bottomBar = {
            ClienteBottomNavigationBar(navController, activeScreen = "edit_user_client_screen")
        }
    ) { innerPadding ->
        LazyColumn(
            modifier = Modifier
                ...
                Card(
                    ...
                    Row(
                        ...
                        Box(
                            ...
                            Text(
                                text = viewModel.email.firstOrNull()?.uppercaseChar()?.toString() ?: "C",
                                color = Color.White,
                                fontFamily = Poppins,
                        ...
                        Column {
                            Text(
                                text = viewModel.email.ifBlank { "Cliente" },
                                color = Color.White,
                                fontFamily = Poppins,
                                fontWeight = FontWeight.SemiBold,
                                fontSize = 15.sp
                            ...
                            Box(
                                modifier = Modifier
                                    .background(Color(0xFF1565C0).copy(alpha = 0.3f), shape = RoundedCornerShape(6.dp))
